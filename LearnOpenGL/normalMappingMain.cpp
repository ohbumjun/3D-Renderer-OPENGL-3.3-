...
//        FileSystem::getPath("LearnOpenGL/NormalMappingVS.glsl");
//    std::string fragShaderPath = 
//        FileSystem::getPath("LearnOpenGL/NormalMappingFS.glsl");
...
//        loadTexture(FileSystem::getPath("BJResource/brickwall.jpg").c_str());
//
//    unsigned int normalMap =
//        loadTexture(FileSystem::getPath("BJResource/brickwall_normal.jpg").c_str());
//
...
//                1.0,
//                0.0,
//                1.0))); // rotate the quad to show normal mapping from multiple directions
...
//
//        float quadVertices[] = {
//            // positions            // normal         // texcoords  // tangent  // bitangent                     // bitangent
